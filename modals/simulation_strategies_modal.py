...
class SimulationStrategiesModal(tk.Toplevel):
    ...
    def __init__(self, parent, candles_df, logger):
        ...
        self.strategy_defaults = {
            "strategy_bollinger_bands_breakout": {"percent_ratio": 0.55, "rr_ratio": 1.2, "sl": 14.0},
            "strategy_candle_pattern_reversal": {"percent_ratio": 0.45, "rr_ratio": 1.3, "sl": 12.0},
            "strategy_chart_pattern_breakout": {"percent_ratio": 0.5, "rr_ratio": 1.4, "sl": 15.0},
            "strategy_fibonacci_reversal": {"percent_ratio": 0.6, "rr_ratio": 1.5, "sl": 16.0},
            "strategy_hybrid_optimizer": {"percent_ratio": 0.65, "rr_ratio": 1.3, "sl": 13.0},
            "strategy_ichimoku_kinko_hyo": {"percent_ratio": 0.55, "rr_ratio": 1.6, "sl": 18.0},
            "strategy_ma_crossover": {"percent_ratio": 0.5, "rr_ratio": 1.2, "sl": 12.0},
            "strategy_momentum_rsi_macd": {"percent_ratio": 0.6, "rr_ratio": 1.4, "sl": 11.0},
            "strategy_price_action_sr": {"percent_ratio": 0.7, "rr_ratio": 1.5, "sl": 10.0},
            "strategy_scalping_stochrsi_ema": {"percent_ratio": 0.45, "rr_ratio": 1.1, "sl": 9.0},
